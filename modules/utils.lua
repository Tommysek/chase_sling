...
local playerSlots = {
    ...
    { 
        { bone = 10706, pos = vec3(0.05, 0.25, -0.15), rot = vec3(-10.0, 75.0, 180.0) },
        { bone = 57597, pos = vec3(0.1, 0.18, 0.13), rot = vec3(-45.09, 3.72, 175.47) },

    },
    { 
        { bone = 24818, pos = vec3(0.075, -0.18, -0.02), rot = vec3(180.0, 165.0, 0.0) },
        { bone = 24818, pos = vec3(0.09, -0.21, 0.002), rot = vec3(-2.65, -73.04, 167.18) },
        { bone = 58271, pos = vec3(0.15, -0.05, -0.1), rot = vec3(-70.0, 0.0, 0.0) },
	},
}
...
function Utils.formatData(itemData, itemConfig, ignoreSlot)
    local isWeapon = itemData.name:lower():find('weapon_')
